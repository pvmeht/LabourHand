...
export function Login() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-primary/5 via-white to-secondary/5 flex flex-col items-center justify-center p-4 overflow-hidden">
      <div className="w-full max-w-md flex flex-col max-h-full">
        ...
        <Card className="p-8 flex-1 overflow-y-auto min-h-0 no-scrollbar">
          {/* Logo */}
